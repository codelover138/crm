...
if (slwarehouse = localStorage.getItem('slwarehouse')) {
     ...
     * Edit Row Modal Hanlder
     ...
     $(document).on('click', '.edit', function () {
       ...
       // $('#productDetails').val(item.row.product_details ? htmlEntityDecode(item.row.product_details) :'' );
         $('#productDetails').html(item.row.product_details ? htmlEntityDecode(item.row.product_details) :'' );
        $('#net_price').text(formatMoney(net_price));
        $('#pro_tax').text(formatMoney(pr_tax_val));
        // $('#prModal').appendTo("#productDetails");
    ...
    $(document).on('click', '.product_info', function () {
        ...
        $('#productDetailsModalLabel').text(item.row.name + ' (' + item.row.code + ')');
        $('#productDetails').html(item.row.product_details ? item.row.product_details :'' );
        console.log(item.row.product_details);
        $('#productDetailsModal').appendTo("body").modal('show');

                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-addon">
                                <input type="checkbox" name="track_quantity" id="inlineCheckbox1" value="1"
                                    <?= ($product ? (!empty($product->track_quantity) ? 'checked="checked"' : '') : 'checked="checked"') ?>>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <input name="cf" type="checkbox" class="checkbox" id="extras" value=""
                            checked="checked" /><label for="extras"
...
$(document).ready(function() {
        ...
        select: function(event, ui) {
            ...
            if (ui.item.id !== 0) {
                ...
                if (row) {
                    ...
                    $('form[data-toggle="validator"]').bootstrapValidator('removeField',
                        'add_item');
                }
            } else {
                //audio_error.play();
    ...
    function add_product_item(item) {
        ...
        $.each(items, function() {
            ...
            tr_html +=
                ...
                formatQuantity2(this.qty) + '" data-id="' + row_no + '" data-item="' + this.id +
    ...
    $(document).on('click', '#updateAttr', function() {
        ...
        row.children().eq(2).html('<input type="hidden" name="attr_quantity[]" value="' + ($(
                '#aquantity').val() ? $('#aquantity').val() : 0) + '"><span>' + $('#aquantity')
            .val() + '</span>');

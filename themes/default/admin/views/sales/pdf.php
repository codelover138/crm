        ...
        <div class="col-lg-12">
            ...
            <div class="padding10">
                ...
                <div class="col-xs-5">
                    ...
                    <h2 class=""><?= $customer->name && $customer->last_name ? $customer->name.' '.$customer->last_name : $customer->company; ?></h2>
                    <?php
            ...
            <div class="col-xs-12">
                ...
                <div class="col-xs-4 pull-right">
                    <p style="height: 80px;"><?= lang('customer'); ?>
                        : <?= ($customer->name && $customer->last_name) ? $customer->name.' '. $customer->last_name : $customer->company; ?> </p>
                    <hr>
                    <p><?= lang('stamp_sign'); ?></p>
